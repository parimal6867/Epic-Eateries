...
import com.example.epiceateries2.HomeActivity;
import com.example.epiceateries2.R;
import com.example.epiceateries2.chefFoodPanel.ChefPreparedOrderView;
import com.example.epiceateries2.chefRestaurant.ChefFoodPanel_BottomNavigation;
import com.example.epiceateries2.customerFoodPannel.PayableOrders;
...
public class ShowNotification {
    ...
    public static void ShowNotif(Context context, String title, String message, String page) {
        ...
        Intent acIntent = new Intent(context, HomeActivity.class);
        ...
        if (page.trim().equalsIgnoreCase("Home")) {
            acIntent = new Intent(context, CustomerPannel.class).putExtra("PAGE", "Homepage");
            pendingIntent = PendingIntent.getActivity(context, 0, acIntent, PendingIntent.FLAG_ONE_SHOT);
        }
        ...
        if (page.trim().equalsIgnoreCase("Preparing")) {
            acIntent = new Intent(context, CustomerPannel.class).putExtra("PAGE", "Preparingpage");
            pendingIntent = PendingIntent.getActivity(context, 0, acIntent, PendingIntent.FLAG_ONE_SHOT);
        }
        if (page.trim().equalsIgnoreCase("Prepared")) {
            acIntent = new Intent(context, CustomerPannel.class).putExtra("PAGE", "Preparedpage");
            pendingIntent = PendingIntent.getActivity(context, 0, acIntent, PendingIntent.FLAG_ONE_SHOT);
        }
        ...
        if (page.trim().equalsIgnoreCase("DeliverOrder")) {
            acIntent = new Intent(context, CustomerPannel.class).putExtra("PAGE", "DeliverOrderpage");
            pendingIntent = PendingIntent.getActivity(context, 0, acIntent, PendingIntent.FLAG_ONE_SHOT);
        }
        ...
        if (page.trim().equalsIgnoreCase("ThankYou")) {
            acIntent = new Intent(context, CustomerPannel.class).putExtra("PAGE", "ThankYoupage");
            pendingIntent = PendingIntent.getActivity(context, 0, acIntent, PendingIntent.FLAG_ONE_SHOT);
        }
        ...
        NotificationCompat.Builder nBuilder = new NotificationCompat.Builder(context, CHANNEL_ID).setSmallIcon(R.drawable.ic_baseline_restaurant_black_24)
