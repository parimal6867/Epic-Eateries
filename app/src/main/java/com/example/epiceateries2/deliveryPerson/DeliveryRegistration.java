...
public class DeliveryRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                            ...
                            if(task.isSuccessful())
                            {
                                ...
                                databaseReference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        firebaseDatabase.getInstance().getReference("delivery person").
        ...
        gmailS.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(DeliveryRegistration.this, "Service Not Started Yet", Toast.LENGTH_LONG).show();
            }
        });
        ...
        emailS.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent el=new Intent(DeliveryRegistration.this, EmailLoginActivity.class);
                startActivity(el);
                finish();
            }
        });
